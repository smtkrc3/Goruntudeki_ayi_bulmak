import cv2
import numpy as np
# kod üzerinde değişiklik yapıyorum, bulutlar ay'ı bulmamı zorlaştırıyor
def find_moon(ay):
    ...
    ret, ay_threshold=cv2.threshold(ay_blur, 170, 255,cv2.THRESH_BINARY) # 85 i 170 a çektim
...
video=cv2.VideoCapture("Moon_Night.mp4")
